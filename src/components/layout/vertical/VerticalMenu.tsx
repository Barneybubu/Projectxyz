...
const VerticalMenu = ({ dictionary, scrollMenu }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem href={`/${locale}/income-and-expenses`} icon={<i className='ri-money-dollar-circle-line' />}>
          {dictionary['navigation'].incomeAndExpenses}
        </MenuItem>

        <MenuItem href={`/${locale}/asset-and-liabilities`} icon={<i className='ri-funds-box-line' />}>
          {dictionary['navigation'].assetAndLiabilities}
        </MenuItem>
